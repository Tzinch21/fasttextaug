...
mod tests {
    ...
    fn test_transform_to_set(){
        let input_mapping = HashMap::from([
            (String::from("A"), vec![String::from("a"), String::from("a"), String::from("c")]),
            (String::from("B"), vec![String::from("b")]),
            (String::from("C"), vec![String::from("c"), String::from("s")])
        ]);
        let mapping_set = transform_to_set(&input_mapping);
        let expected_result = HashMap::from([
            (String::from("A"), HashSet::from([String::from("a"), String::from("c")])),
            (String::from("B"), HashSet::from([String::from("b")])),
            (String::from("C"), HashSet::from([String::from("c"), String::from("s")]))
        ]);
    ...
    fn test_reverse(){
        let mut hash: Mapping = HashMap::from([
            (String::from("A"), vec![String::from("x"), String::from("y")]),
            (String::from("B"), vec![String::from("b")]),
            (String::from("C"), vec![String::from("x"), String::from("x")]),
            (String::from("D"), vec![String::from("d")]),
            (String::from("d"), vec![String::from("D")]),
        ]);
        let expected_result = HashMap::from([
            (String::from("A"), HashSet::from([String::from("x"), String::from("y")])),
            (String::from("B"), HashSet::from([String::from("b")])),
            (String::from("C"), HashSet::from([String::from("x")])),
            (String::from("x"), HashSet::from([String::from("C"), String::from("A")])),
