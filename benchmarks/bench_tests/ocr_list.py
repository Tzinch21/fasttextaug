...
if __name__ == "__main__":
    ...
    for num_thread in (1, 2, 4, 8):
        ...
        my_bench = timeit.repeat(partial(my_lib_ocr_aug.augment, data=REVIEWS, num_thread=num_thread), repeat=REPEATS, number=NUMBER_MY_LIB)
        ...
        if num_thread == 1:
            lib_bench = timeit.repeat(partial(exist_lib_ocr_aug.augment, data=REVIEWS, num_thread=num_thread), repeat=REPEATS, number=NUMBER_THEIR_LIB)
